...
full.merge.df <- left_join(Victoria.thornhill.merge.df, EUCLID.traits.df, by = "name")
view(full.merge.df)
write.csv(full.merge.df, "../outputs/datasets_in_progress/victoria_thornhill_euclid_merge.csv")
